...
function user_create( $p_username, $p_password, $p_email = '', $p_access_level = null, $p_protected = false, $p_enabled = true, $p_realname = '', $p_send_verification_email = true ) {
	...
	if ( $p_send_verification_email && !is_blank( $p_email ) ) {
