...
# along with Mantis.  If not, see <http://www.gnu.org/licenses/>.
	...
	$t_access_levels = Mantis_Enum::getAssocArrayIndexedByValues( config_get( 'access_levels_enum_string' ) );
	...
	function get_section_begin_mcwt( $p_section_name ) {
		...
		foreach( $t_access_levels as $t_access_level => $t_access_label ) {
			echo '<td class="form-title" style="text-align:center">&nbsp;' . Mantis_Enum::getLabel( lang_get( 'access_levels_enum_string' ), $t_access_level ) . '&nbsp;</td>';
		}
		echo '</tr>' . "\n";
	}
	...
	function get_capability_enum( $p_caption, $p_threshold, $p_enum, $p_all_projects_only=false ) {
		...
		if ( $t_can_change ) {
			...
			$t_value = Mantis_Enum::getLabel( lang_get( $p_enum . '_enum_string' ), config_get( $p_threshold ) ) . '&nbsp;';
